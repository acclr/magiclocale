...
export const BOXYHQ_UI_CSS = {
  button: {
    ...
    cancel: 'inline-flex h-8 items-center justify-center rounded-lg px-2.5 text-sm',
  },
  ...
  secretInput: 'h-8 w-full rounded-lg border border-input bg-transparent px-2.5 text-sm',
  section: 'mb-8',
};
